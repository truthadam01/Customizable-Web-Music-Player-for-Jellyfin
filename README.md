...
As an example, the IP to reach the Webserver looks like this : http://YOUR IP/web/Webserver.html

While Jellyfin looks like this : http://YOUR IP/web/#/home

The Imortant point is as seen in the Screenshots, the whole Metadata must be given by yourself. For that purpose i recommend Software like Picard Musicbrain or/and MP3TAG for Windows.
